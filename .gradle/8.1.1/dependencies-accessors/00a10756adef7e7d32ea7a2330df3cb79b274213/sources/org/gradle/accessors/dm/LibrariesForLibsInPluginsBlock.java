...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinPluginAccessors extends PluginFactory  implements PluginNotationSupplier{
        ...
        public KotlinPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for kotlin.serilization to the plugin id 'org.jetbrains.kotlin.plugin.serilization'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getSerilization() { return createPlugin("kotlin.serilization"); }
