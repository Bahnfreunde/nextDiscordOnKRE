...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinPluginAccessors extends PluginFactory  implements PluginNotationSupplier{
        ...
        public KotlinPluginAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Creates a plugin provider for kotlin.seriliation to the plugin id 'org.jetbrains.kotlin.plugin.seriliation'
             * This plugin was declared in catalog libs.versions.toml
             */
            public Provider<PluginDependency> getSeriliation() { return createPlugin("kotlin.seriliation"); }
